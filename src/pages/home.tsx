...
const viewerNodes: NodePoint[] = [
  {
    ...
    tone: "sky",
    image:
      "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=96&h=96&q=55",
  },
  {
    id: "v2",
    x: 15,
    ...
    tone: "mint",
    image:
      "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=96&h=96&q=55",
  },
  {
    id: "v3",
    x: 7,
    ...
    tone: "rose",
    image:
      "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&w=96&h=96&q=55",
  },
  {
    id: "v4",
    x: 22,
    ...
    tone: "gold",
    image:
      "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=96&h=96&q=55",
  },
  {
    id: "v5",
    x: 28,
    ...
    tone: "rose",
    image:
      "https://images.unsplash.com/photo-1527980965255-d3b416303d12?auto=format&fit=crop&w=96&h=96&q=55",
  },
  {
    id: "v6",
    x: 19,
    ...
    tone: "sky",
    image:
      "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=96&h=96&q=55",
  },
  {
    id: "v7",
    x: 32,
    ...
    tone: "mint",
    image:
      "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=96&h=96&q=55",
  },
  {
    id: "v8",
    x: 12,
    ...
    tone: "gold",
    image:
      "https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?auto=format&fit=crop&w=96&h=96&q=55",
  },
];
...
const appDownloadLinks = [
  {
    ...
    href: "mailto:info@adbox.com?subject=Adbox%20iPhone%20app%20download%20link",
    icon: Apple,
  },
  {
    label: "Android app link",
    detail: "Request download",
    href: "mailto:info@adbox.com?subject=Adbox%20Android%20app%20download%20link",
    icon: Smartphone,
  },
];
      ...
      <div className="adbox-page text-white">
          ...
          <div className="nav-inner">
            ...
            >
              <img
                ...
                src="/AdBox-logo-Coloured-Light.svg"
                alt="Adbox"
              />
            </button>
            ...
            <div className="desktop-nav">
              ...
              <button
                className="nav-cta"
                onClick={() => scrollToSection("download_app")}
              >
                Start now
              </button>
            </div>
          ...
          <div className="hero-content">
            ...
            >
              <div className="eyebrow">
                ...
                AI-powered customer to business owner network
              </div>
              <h1>
                A bigger, brighter way to connect customers with business
                owners.
              </h1>
              <p>
        ...
        <section id="network" className="network-story-section">
          <div className="section-heading">
            ...
            <h2>
              Customers and business owners do not sit in separate worlds
              anymore.
            </h2>
            <p>
              Adbox acts like a live bridge between attention and ambition:
              customers create momentum, business owners receive measurable
              demand, and AI helps the network learn where the next conversion
              should go.
            </p>
          </div>
          ...
          <div className="team-showcase">
            ...
            <div className="team-copy">
              ...
              <h3>
                Built close to the people, creators, and businesses it serves.
              </h3>
              <p>
                Adbox brings local market insight, campaign execution, and live
                audience feedback into one path, so business owners can move
                from idea to measurable demand without guesswork.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="download_app" className="app-download-section">
          <div className="app-download-copy">
            ...
            <p>
              Launch campaigns, follow customer activity, and track business
              growth from the Adbox mobile app.
            </p>
        ...
        <section id="success_stories" className="results-section">
          <div className="section-heading">
            ...
            <h2>
              Every campaign becomes a visible path from attention to action.
            </h2>
          </div>
        ...
        <section className="cta-section">
          <div className="cta-panel">
            <div>
              ...
              <p>
                Start with a focused campaign, measure the response, and scale
                into the channels that are already producing customers.
              </p>
            </div>
            <div className="cta-actions">
              ...
              {/* <button
                className="secondary-action dark-outline"
        ...
        <footer id="contact" className="footer-section">
          <div className="footer-brand">
            ...
            <p>
              AI-powered digital advertising for connecting business owners with
          ...
          <div className="footer-contact">
            ...
            <a href="mailto:info@adbox.com">
              <Mail className="h-4 w-4" /> info@adbox.com
            </a>
            <span>
            ...
            {/* <span>
              <MapPin className="h-4 w-4" /> Built for growth markets
            </span> */}
          </div>
        </footer>
      </div>
